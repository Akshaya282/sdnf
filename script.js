...
let healthReasonTimeout = null;

function showHealthReason(reason){

    let el = document.getElementById("health-reason");

    el.textContent = reason;

    el.classList.add("show");

    clearTimeout(healthReasonTimeout);

    healthReasonTimeout = setTimeout(()=>{
...
function routePacket(choice){
    ...
    if(currentPacket === "MALWARE"){
        ...
        if(choice === 0){
            ...
            showHealthReason(
                "-15% Health: MALWARE not sent to Drop Box"
            );
        ...
        if(choice === correctServer){
            ...
            showHealthReason(
                "-10% Health: " + currentPacket + " misrouted (should go to " + destination + ")"
            );
...
function startRandomEvents(){
    ...
    setInterval(()=>{
        ...
        if(randomEvent === "Congestion"){
            ...
            showHealthReason("-5% Health: Network Congestion");
            ...
            showHealthReason("-8% Health: DDoS Attack");
            ...
            showHealthReason("-3% Health: Bandwidth Reduction");
            ...
            showHealthReason("-2% Health: Packet Loss");
